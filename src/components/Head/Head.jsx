    ...
    return (
        ...
        <div className="grid grid-flow-col p-5 m-2 shadow-md ">
            ...
            <div className="col-span-10 flex items-center">
                ...
                <input onChange={handleChange} placeholder="Search" className="border-2 h-10 rounded-l-full w-1/2 cursor-pointer" type="text" />
                <button className="border-2 h-10 rounded-r-full px-3"><img className="h-8" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQ1DQ3CsVs5UQQFkRCi_T2LzJe3aFOPJzrpkRv7lZXUdU3TjPCL" alt="search-icon"/></button>
                <img className="h-6 pl-5" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcT4jV_ugKjNeBsDitWlP_EySobxdmp4dMFAK5T2NHMJdJLwas0U" alt="audio-icon"/>
