    ...
    return (
        ...
        <div className="grid grid-flow-col p-5 m-2 shadow-md">
            ...
            <div className="col-span-10">
                ...
                <input className="border-2 rounded-l-full w-1/2 " type="text" />
                <button className="border-2 rounded-r-full px-3">Search</button>
